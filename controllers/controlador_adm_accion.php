...
class controlador_adm_accion extends system {
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $this->modelo->campos_view['adm_seccion_id']['type'] = 'selects';
        ...
        bool $header, bool $ws = false, string $breadcrumbs = '', bool $aplica_form = true, bool $muestra_btn = true): array|string|stdClass
    {
        $r_modifica = parent::modifica(
            header: $header,ws:  $ws,breadcrumbs:  $breadcrumbs,aplica_form:  $aplica_form,muestra_btn:  $muestra_btn); // TODO: Change the autogenerated stub
        if(errores::$error){
